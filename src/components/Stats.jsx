...
export const Stats = () => {
  return (
    <div className='flex lg:flex-row md:flex-col md:gap-y-5 md:w-fit flex-col gap-y-5 mb-5  items-center justify-around  shadow-lg   rounded-md m-5 p-5 w-11/12 mx-auto '>
